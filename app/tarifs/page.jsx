...
const page = () => {
  ...
  const { data, error } = useSWR(
    'https://charles-cantin-strapi-01d205b7c2c1.herokuapp.com/api/pricings?populate=*',() => fetcherWithToken('https://charles-cantin-strapi-01d205b7c2c1.herokuapp.com/api/pricings?populate=*', accessToken)
  );
